...
namespace NECS.Editor
{
    public class TreeView : VisualElement
    {
        ...
        public static readonly int _lineHeight = 30;
        
        public new class UxmlFactory : UxmlFactory<TreeView, UxmlTraits> {}

        public new class UxmlTraits : VisualElement.UxmlTraits
        {
            private readonly UxmlIntAttributeDescription m_ItemHeight = new UxmlIntAttributeDescription { name = "item-height", defaultValue = _lineHeight };
        ...
        public float resolvedItemHeight => m_ListView.fixedItemHeight;
        ...
        */
        ...
        {
            get { return m_ListView.fixedItemHeight; }
